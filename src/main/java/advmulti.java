...
public class advmulti {
    ...
    public static class advmultiMapper extends Mapper<Object, Text, IntWritable, Text>{
...
//            System.out.println("Test");
    ...
    public static class advmultiReducer
    ...
    public void KMeansIteration(String[] args, int iter) throws Exception {
        ...
        job.setReducerClass(advmultiReducer.class);
